<template>
    <div v-if="sub">
        <div v-if="!showInput" class="flex flex-row w-full items-center bg-gray-200 pl-4 rounded-lg my-1">
            ...
            <button @click="approve(sub._id)" class="px-2 py-1 bg-white hover:bg-gray-300 focus:bg-theme-light focus:text-white border-solid border border-r-0 border-l-0 border-theme-light outline-none focus:outline-none">Approve</button>
            <button @click="showInput = true" class="px-2 py-1 bg-white hover:bg-gray-300 focus:bg-theme-light focus:text-white rounded-r-lg border-solid border border-theme-light outline-none focus:outline-none">Reject</button>
        </div>
